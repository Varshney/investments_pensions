        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('investment_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/investment-plans*")||request()->is("admin/investment-types*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                        ...
                        <ul class="ml-4 subnav hidden">
                            @can('investment_plan_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/investment-plans*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.investment-plans.index") }}">
                            ...
                            @endcan
                            @can('investment_type_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/investment-types*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.investment-types.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-keyboard">
                                        </i>
                                        {{ trans('cruds.investmentType.title') }}
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                @can('pension_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/pension-types*")||request()->is("admin/pension-plans*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-heartbeat">
                            </i>
                            {{ trans('cruds.pension.title') }}
                        </a>
                        <ul class="ml-4 subnav hidden">
                            @can('pension_type_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/pension-types*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.pension-types.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-keyboard">
                                        </i>
                                        {{ trans('cruds.pensionType.title') }}
                                    </a>
                                </li>
                            @endcan
                            @can('pension_plan_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/pension-plans*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.pension-plans.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                                        {{ trans('cruds.pensionPlan.title') }}
                                    </a>
                                </li>
                            @endcan
                        </ul>
